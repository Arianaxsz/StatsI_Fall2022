...
# have? '651'Try using the as.factor() function to transform it to
# a factor.
...
# function to transform it. What goes wrong? NA are given as the values as characters

summary(dat$top200_box)
typeof(dat$top200_box)
as.logical()             #not too sure how this is done tbh! 
